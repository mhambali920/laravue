        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                    <Link :href="route('contact.create')" class="inline-block mb-4">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white">
                            <tr v-for="contact in contacts" :key="contact.id" class="text-gray-700">
                                <td class="px-4 py-3 border">{{contact.name}}</td>
                                <td class="px-4 py-3 border">{{contact.phone}}</td>
                                <td class="px-4 py-3 border">{{contact.address}}</td>
                                <td class="px-4 py-3 border">{{contact.notes}}</td>
                                <td class="px-4 py-3 text-sm border">
                                    <Link :href="route('contact.edit', contact.id)" class="mr-4">
