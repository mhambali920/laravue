                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                    ...
                    <form @submit.prevent="store" class="mt-4">
                        <div class="px-8">
                            ...
                            <div class="mb-2">
                                <label for="notes" class="block font-medium text-sm text-gray-700">Info Tambahan</label>
                                <input v-model="form.notes" type="text" class="w-full md:w-1/2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"/>
